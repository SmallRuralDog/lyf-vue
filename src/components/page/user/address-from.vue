...
<div class="page">
  <div class="page-content">
    ...
    <hl-item class="item-icon-right" @click.native="choseAdd">地区<div class="item-note">请选择地区</div><span class="icon ion-ios-arrow-right"></span></hl-item>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$api.userAuthGet("get_area", res => {
